...
BOT_TOKEN = env_str("TELEGRAM_BOT_TOKEN_AVENGERS", env_str("TELEGRAM_BOT_TOKEN", "")).strip()
ALLOWED_USER = env_str("TELEGRAM_ALLOWED_USER_ID", "").strip()
COMMAND_NAMESPACE = env_str("TELEGRAM_COMMAND_NAMESPACE", "av").strip().strip("/")
