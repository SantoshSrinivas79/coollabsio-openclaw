...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--log-title", default="Mentor Memory Log", help="Markdown title prefix for the daily log")
...
def render_markdown(
    ...
    lines: list[str] = []
    lines.append(f"# {log_title} - {target_date}")
    lines.append("")
...
def main() -> int:
    ...
    content = render_markdown(target_date, tz, entries, len(sessions_seen), args.agents, args.log_title)
