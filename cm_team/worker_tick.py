...
from cm_team.executor import run_executor
...
from cm_team.packager import build_exec_packet
from cm_team.templates import review_instructions_md
from cm_team.validate import validate_result
...
def main() -> None:
    ...
    ap.add_argument("--role", required=True, choices=["researcher", "copywriter", "qa", "humanizer"])
    args = ap.parse_args()
