...
from cm_team.lib_queue import read_json, read_text, write_text
...
def role_soul_filename(role: str) -> str:
    mapping = {
        "researcher": "02_researcher.md",
        "copywriter": "03_copywriter.md",
        "qa": "04_qa_reviewer.md",
        "humanizer": "05_humanizer.md",
    }
